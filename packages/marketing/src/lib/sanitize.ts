...
export function sanitizeJsonLd(value: string): string {
	return (
		value
			...
			// biome-ignore lint/suspicious/noControlCharactersInRegex: intentionally strips C0/C1 control chars from JSON-LD output to prevent injection via Unicode control sequences
			.replace(/[\u0000-\u001F\u007F-\u009F]/g, "")
