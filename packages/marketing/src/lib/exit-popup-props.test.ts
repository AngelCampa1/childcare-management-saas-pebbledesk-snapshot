...
import { EXIT_POPUP_DEFAULTS } from "./exit-popup-defaults";
...
describe("resolveExitPopupProps", () => {
	it("keeps default lead magnet privacy copy focused only on the requested resource", () => {
		expect(EXIT_POPUP_DEFAULTS.privacyNote).toContain("We will email the resource");
		expect(EXIT_POPUP_DEFAULTS.privacyNote.toLowerCase()).not.toContain("follow-up");
		expect(EXIT_POPUP_DEFAULTS.privacyNote.toLowerCase()).not.toContain("sequence");
		expect(EXIT_POPUP_DEFAULTS.privacyNote.toLowerCase()).not.toContain("unsubscribe");
		expect(EXIT_POPUP_DEFAULTS.privacyNote.toLowerCase()).not.toContain("no spam");
		expect(EXIT_POPUP_DEFAULTS.privacyNote.toLowerCase()).not.toContain("spam");
	});
