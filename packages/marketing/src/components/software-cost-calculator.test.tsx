...
const defaultProps = {
	...
	ctaText: "Start Your 30-Day Free Trial — No Setup Fees →",
...
describe("SoftwareCostCalculator", () => {
	describe("rendering", () => {
		...
		it("renders the CTA button linking to trialUrl", () => {
			...
			const link = screen.getByRole("link", {
				name: /start your 30-day free trial/i,
	...
	describe("slider interaction", () => {
		...
		it("calls trackEvent when slider changes", () => {
			...
			expect(trackEvent).toHaveBeenCalledWith(ANALYTICS_EVENTS.costCalculatorTeamSizeChanged, {
				team_size: 7,
			});
		});
	...
	describe("CTA", () => {
		...
		it("CTA text contains 'No Setup Fees'", () => {
			render(<SoftwareCostCalculator {...defaultProps} />);
			expect(screen.getByText(/start your 30-day free trial.*no setup fees/i)).toBeDefined();
		});
	});
