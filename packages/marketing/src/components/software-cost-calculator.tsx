...
import { type CompetitorPricing, generateComparison } from "../lib/competitor-cost-calculator";
...
export function SoftwareCostCalculator({
	...
	function handleSliderChange(e: React.ChangeEvent<HTMLInputElement>) {
		...
		setTeamSize(val);
		trackEvent(ANALYTICS_EVENTS.costCalculatorTeamSizeChanged, { team_size: val });
	}
	...
	return (
		...
		>
							...
							{results.map((result) => {
								...
								return (
									<tr
										...
										className={clsx(isProduct && "border-l-4 border-[var(--color-primary-500)]")}
										style={{
			...
			{/* CTA */}
			<div>
				<a href={trialUrl} className="btn-primary inline-flex items-center gap-2">
					{ctaText}
				</a>
			</div>
		</div>
