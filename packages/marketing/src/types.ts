...
export type NavItemConfig = NavItem | NavMegaMenuItem;
...
export interface PromoBannerConfig {
	/** Unique code for this promo. Used as the localStorage key for dismissal. */
	code: string;
	/** Headline label for the promotion. */
	label: string;
	/** Public regular-price line after the offer. */
	renewalLabel?: string;
	/** Expiry date in YYYY-MM-DD format. The banner auto-hides after this date (UTC). */
	validThrough?: string | null;
	/** Public promo prefix, e.g. "Limited offer". */
	urgencyLabel?: string;
	/** Optional CTA destination, e.g. "/pricing/". */
	ctaHref?: string;
	/** Optional CTA label, defaults to "View pricing". */
	ctaLabel?: string;
	/** Optional emoji prefix, defaults to "🎉". */
	emoji?: string;
}
...
export interface SiteConfig {
	...
	/** Optional site-wide promotional banner shown above the header. Auto-hides after validThrough. */
...
export interface PricingTier {
	...
	name: string;
	price: string;
	monthlyPriceCents?: number; // enables annual toggle + computed price
